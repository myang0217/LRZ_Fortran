...
set logscale x 10 
set output 'plot_loa_aos_soa.png'
set title ''
set key top right
...
plot 'SandyBridge_2.3_AVX_loa_bsize256.res' using 1:3 title 'Loa(256)' with lines ls 1, \
     'SandyBridge_2.3_AVX_aos.res' using 1:3 title 'AoS' with lines ls 2, \
     'SandyBridge_2.3_AVX_soa.res' using 1:3 title 'SoA' with lines ls 3
